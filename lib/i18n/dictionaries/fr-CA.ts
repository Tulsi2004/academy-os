...
export const frCA: Dictionary = {
  ...
  enquiries: {
    ...
    convert: {
      ...
      studentHint: "Déjà repris de la demande — vérifiez seulement que le nom est bien séparé.",
      prefilled: "de la demande",
      firstName: "Prénom",
  ...
  students: {
    ...
    search: {
      placeholder: "Chercher un élève, un parent ou un numéro…",
      label: "Rechercher des élèves",
    },
    countOne: "{count} élève",
    countOther: "{count} élèves",
    columns: {
      student: "Élève",
      parent: "Parent",
      phone: "Téléphone",
    ...
    empty: {
      none: "Aucun élève pour l'instant.",
      noneHint: "Ajoutez ceux qui apprennent déjà ici, ou inscrivez une demande.",
      addFirst: "Ajouter un premier élève",
      noMatch: "Aucun résultat pour cette recherche.",
      noMatchHint: "Essayez une partie du nom ou les derniers chiffres du numéro.",
    },
    detail: {
      back: "Retour aux élèves",
      admittedOn: "Inscrit le {date}",
      fromEnquiry: "d'une demande du {date}",
      student: "Élève",
      parent: "Parent / tuteur",
      name: "Nom",
      phone: "Téléphone",
      ...
      address: "Adresse",
      batches: "Groupes",
      noBatches: "Pas encore dans un groupe. Vous pourrez en assigner un quand ce module sera prêt.",
      payments: "Paiements",
    ...
    new: {
      ...
      subtitle: "Pour quelqu'un qui apprend déjà à l'académie et n'est jamais passé par une demande.",
      submit: "Ajouter un élève",
      submitting: "Ajout…",
    },
  },
  ...
  errors: {
    ...
    dateOutOfRange: "Choisissez une date dans les cinq ans",
    dateFuture: "Cette date est dans le futur",
    nameRequired: "Le nom est obligatoire",
    courseExists: "Un cours porte déjà ce nom.",
    courseArchivedExists: "Un cours archivé porte déjà ce nom — restaurez-le au lieu d'en créer un autre.",
    courseNotFound: "Cours introuvable.",
    courseSaveFailed: "Impossible d'enregistrer le cours. Vérifiez votre connexion et réessayez.",
