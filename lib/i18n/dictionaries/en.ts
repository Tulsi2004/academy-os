...
export const en = {
  ...
  enquiries: {
    ...
    */
    ...
    convert: {
      ...
      studentHint: "Already carried over from the enquiry — just check the name is split correctly.",
      prefilled: "from the enquiry",
  ...
  students: {
    ...
    empty: {
      ...
      noneHint: "Add the students already learning here, or admit an enquiry.",
    ...
    detail: {
      ...
      admittedOn: "Joined {date}",
      fromEnquiry: "from an enquiry on {date}",
      student: "Student",
      parent: "Parent / guardian",
      name: "Name",
      phone: "Phone",
      ...
      address: "Address",
      batches: "Batches",
      noBatches: "Not in a batch yet. Batches can be assigned once that module is built.",
      payments: "Payments",
      received: "{amount} received",
      noPayments: "Nothing paid yet.",
      paymentType: "Type",
    ...
    new: {
      title: "Add a student",
      subtitle: "For someone already learning at the academy who never came through an enquiry.",
      submit: "Add student",
      submitting: "Adding…",
    },
  },
  ...
  errors: {
    ...
    dateOutOfRange: "Pick a date within five years",
    dateFuture: "That date is in the future",
    nameRequired: "Name is required",
    courseExists: "A course with this name already exists.",
    courseArchivedExists: "An archived course already has this name — restore it instead.",
    courseNotFound: "Course not found.",
    courseSaveFailed: "Could not save the course. Check your connection and try again.",
